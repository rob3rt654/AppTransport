        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="vistaBuses.php">
                            <i class="fas fa-bus text-blue"></i>Autobuses
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="vistaRutas.php">
                            <i class="fas fa-map text-yellow"></i> Rutas
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="vistaChoferes.php">
                            <i class="fas fa-id-card text-red"></i> Conductores

                        </a>
                    </li>
                    <li class="nav-item  active ">
                        <a class="nav-link active " href="vistaAdministradores.php">
                            <i class="fas fa-users-cog text-red"></i> Administradores
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="vistaHorario.php">
                            <i class="fas fa-calendar text-pink"></i> Horarios
                        </a>
                    </li>
    ...
    <div class="main-content">
        ...
        <div class="container-fluid mt-4">
            ...
            <div class="tabla-principal">
                ...
                <table class="display table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%" id="tbAdmis">
                    <thead>
                        <tr>
                            <th>Nombre</th>
                            <th>Apellido</th>
        ...
        <div id="modalAdmi" class="modal fade" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Registro de Administradores</h5>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input" id="nombre" placeholder="Nombre" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" required>

                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control input" id="apellidos" placeholder="Apellidos" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="input-group mb-4">
                                            ...
                                            <input type="email" class="form-control input" id="correo" value=" " placeholder="Correo" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="input-group mb-4">
                                            ...
                                            <input type="text" class="form-control input" id="contrasena" placeholder="Contraseña" pattern="[A-Za-z0-9]+" required>
        ...
        <div id="modalEliminar" class="modal fade">
            <div class="modal-dialog modal-confirm">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <input type="hidden" id="admiEliminar">
